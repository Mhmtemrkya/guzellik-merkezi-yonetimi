...
public interface ICustomServiceCategoryService
{
    ...
    Task<Result<IReadOnlyCollection<CustomServiceCategoryDto>>> ReorderAsync(Guid tenantId, ReorderCustomServiceCategoryRequest request, CancellationToken cancellationToken = default);
}
