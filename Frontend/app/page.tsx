...
function BrandMark() {
  return (
    <a href="#top" className="group flex items-center gap-3" aria-label="BeautyAssist ana sayfa">
      <span className="grid h-11 w-11 place-items-center overflow-hidden rounded-2xl border border-[#ead8df] bg-white shadow-[0_14px_34px_-24px_rgba(142,63,91,0.65)]">
        <img src="/logo.png" alt="BeautyAssist logosu" className="h-full w-full scale-125 object-cover transition duration-500 group-hover:scale-110" />
      </span>
      <span className="leading-none">
        <span className="block font-display text-[18px] tracking-[-0.04em] text-[#6f4153]">BeautyAssist</span>
