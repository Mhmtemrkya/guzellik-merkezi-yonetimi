  ...
  const profileEditDialog = tenant && (
    <AdminEditDialog
      ...
      fields={[
        ...
        { label: 'Domain', name: 'domain', value: tenant.domain.replace(/\.armonessa\.app$/, ''), icon: Tag },
        ...
        <motion.section initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: 0.26 }}
          ...
          <div className="grid gap-0 lg:grid-cols-[.65fr_1fr]">
            <div className="border-b border-[#ead8df]/70 p-6 lg:border-b-0 lg:border-r">
              ...
              <div className="mt-4 font-display text-4xl tabular-nums armonessa-text-gradient">{usage.planMonthlyPriceTRY === 0 ? 'Özel' : formatTL(usage.planMonthlyPriceTRY)}</div>
