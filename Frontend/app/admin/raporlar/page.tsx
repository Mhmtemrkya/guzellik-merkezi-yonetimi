                  ...
                  {sortedServiceStats.map((s, i) => {
                    ...
                    return (
                      <motion.div key={s.service.id} variants={listRow} whileHover={{ x: 4 }} className="grid items-center gap-3 py-3 md:grid-cols-12">
                        ...
                        <div className="md:col-span-1 text-right font-display tabular-nums armonessa-text-gradient">{formatTL(s.revenue)}</div>
                      </motion.div>
                    )
                  })}
        ...
        {headerRight ?? (
          <div className="grid grid-cols-3 gap-3 text-right">
            <div>
              ...
              <div className="font-display text-sm tabular-nums armonessa-text-gradient">{formatTL(Math.round(maxValue))}</div>
            </div>
            <div>
