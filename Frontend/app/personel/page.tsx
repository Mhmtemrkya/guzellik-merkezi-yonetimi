        ...
        <div className="grid gap-4 xl:grid-cols-[1.5fr_1fr]">
          <div className="space-y-4">
            ...
            <PanelSection
              ...
              action={(
                <Link href="/personel/randevular" className="inline-flex shrink-0 items-center gap-1.5 rounded-[10px] border border-[#ead8df] bg-white px-3 py-1.5 text-[11px] font-medium text-[#7c6170] transition-colors hover:border-[#efbfd0] hover:text-[#c85776]">
            ...
            <PanelSection eyebrow="Sıradakiler" title="Yaklaşan randevularım">
              <div className="divide-y divide-[#f3e7ec]">
                {laterAppointments.map((item) => {
                  ...
                  return (
                    <Link key={item.id} href="/personel/randevular" className="flex items-center gap-3 px-5 py-3 transition-colors hover:bg-[#fffafc]">
