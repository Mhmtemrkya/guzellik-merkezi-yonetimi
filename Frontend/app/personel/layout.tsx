...
const personelItems: SidebarNavItem[] = [
  ...
  },
  {
    group: 'İşletme',
    label: 'Hediye Çeki',
    href: '/personel/hediye-cek',
    icon: Gift,
    permissionKey: 'GiftCards',
    featureKeys: ['marketing.giftcards'],
    children: [
      { label: 'Tümü', href: '/personel/hediye-cek?scope=all' },
      { label: 'Aktif', href: '/personel/hediye-cek?scope=active' },
    ],
  },
  {
    group: 'İşletme',
    label: 'Bekleme Listesi',
    href: '/personel/bekleme-listesi',
    icon: CalendarClock,
...
const ROUTE_PERMISSION_GUARDS: Array<{ prefix: string; permissionKey: string; label: string }> = [
  ...
  { prefix: '/personel/bekleme-listesi', permissionKey: 'Waitlist', label: 'Bekleme Listesi' },
  { prefix: '/personel/hediye-cek', permissionKey: 'GiftCards', label: 'Hediye Çeki' },
  { prefix: '/personel/kasa-kapanis', permissionKey: 'CashClosing', label: 'Kasa Kapanışı' },
...
const ROUTE_FEATURE_GUARDS: Array<{ prefix: string; anyOf: FeatureKey[]; title: string }> = [
  ...
  { prefix: '/personel/bekleme-listesi', anyOf: ['appointments.waitlist'], title: 'Bekleme listesi paketinizde yok' },
  { prefix: '/personel/hediye-cek', anyOf: ['marketing.giftcards'], title: 'Hediye çeki paketinizde yok' },
  { prefix: '/personel/kasa-kapanis', anyOf: ['finance.cashclosing'], title: 'Kasa kapanışı paketinizde yok' },
  {
