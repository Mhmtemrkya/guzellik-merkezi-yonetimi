...
OUT = Path('/home/kaya/projects/guzellik-frontend/Armonessa-Flutter-Mobil-Uygulama-Brief.pdf')
MD = Path('/home/kaya/projects/guzellik-frontend/Armonessa-Flutter-Mobil-Uygulama-Brief.md')
...
platform_pages = [
('Platform Overview','/platform','Armonessa tenant yönetimi.','Toplam kurum, MRR, toplam kullanıcı, uptime, kurum tablosu, durum etiketleri.'),
...
landing_pages = [
('Landing / Ana Sayfa','/','Armonessa pazarlama sayfası: hero, problem akışı, çözüm, modüller, müşteri demo, süreç, fiyatlandırma, SSS, footer.'),
...
story.append(P('Armonessa', 'CoverTitle'))
...
for b in [
    'Armonessa; güzellik merkezleri için müşteri, paket/hizmet, taksit, seans, randevu, kasa, ön muhasebe, bildirim, stok ve raporlama yönetimidir.',
...
for b in ['Kurum Yöneticisi: güzellik merkezi sahibi/yönetici; /admin paneline gider.', 'Personel: estetisyen/resepsiyon/muhasebe; /personel paneline gider.', 'Platform Admin: Armonessa ekibi; /platform paneline gider.', 'Mobilde gerçek auth gelene kadar rol seçimi + demo login korunabilir.']:
    story.append(bullet(b))
...
# markdown copy
md = []
md.append('# Armonessa Flutter Mobil Uygulama Briefi\n')
...
def footer(canvas, doc):
    ...
    canvas.drawString(1.4*cm, 1.0*cm, 'Armonessa Flutter Mobil Brief')
