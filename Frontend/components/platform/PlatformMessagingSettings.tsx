        ...
        {loading ? <div className="py-4 text-center text-[12px] text-[#fff4f8]/40">Yükleniyor…</div> : (
          <>
            ...
            <div>
              ...
              <input value={sms.sender} onChange={(e) => setSms((s) => ({ ...s, sender: e.target.value }))} placeholder={sms.provider === 'Twilio' ? '+1xxx' : 'ARMONESSA'} className={inputCls} />
            </div>
      ...
      <div className={`${card} flex flex-col gap-4 p-5`}>
        ...
        {loading ? <div className="py-4 text-center text-[12px] text-[#fff4f8]/40">Yükleniyor…</div> : (
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div><label className={labelCls}>Gönderen adres</label><input value={email.fromAddress} onChange={(e) => setEmail((s) => ({ ...s, fromAddress: e.target.value }))} placeholder="bilgi@armonessa.com" className={inputCls} /></div>
              <div><label className={labelCls}>Gönderen adı</label><input value={email.fromName} onChange={(e) => setEmail((s) => ({ ...s, fromName: e.target.value }))} placeholder="Armonessa" className={inputCls} /></div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div><label className={labelCls}>Kullanıcı</label><input value={email.username} onChange={(e) => setEmail((s) => ({ ...s, username: e.target.value }))} placeholder="bilgi@armonessa.com" className={inputCls} /></div>
