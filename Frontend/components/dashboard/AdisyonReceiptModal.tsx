      ...
      >
        ...
        <div className="relative shrink-0 border-b border-[#f2e2e9] bg-gradient-to-br from-[#fff5f8] via-white to-[#fff1f6] px-5 py-4">
          ...
          <div className="flex items-start justify-between gap-3 pr-10">
            <div className="flex min-w-0 items-center gap-2.5">
              ...
              <div className="min-w-0">
                <div className="text-[9.5px] font-mono uppercase tracking-widest text-[#8C4460]">Adisyon fişi</div>
                <DialogTitle className="truncate text-[17px] font-bold tracking-tight text-[#2b1e29]">
                  {adisyon.customerName || 'Müşteri'}
                </DialogTitle>
                <DialogDescription className="mt-0.5 flex flex-wrap items-center gap-x-2 gap-y-0.5 text-[11px] text-[#74616A]">
                  <span className="inline-flex items-center gap-1"><CalendarDays className="h-3 w-3 text-[#A5556E]" /> Açılış {formatDay(adisyon.openedAtUtc)}</span>
          ...
          <div className="mt-3 grid grid-cols-3 gap-px overflow-hidden rounded-[14px] border border-[#f0dae2] bg-[#f7e9ee] text-center">
            ...
            <div className="bg-white px-2 py-2.5">
              <div className="text-[9px] font-mono uppercase tracking-wide text-[#8C4460]">{net >= 0 ? 'Kalan' : 'Fazla'}</div>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4">
          ...
          <div className="overflow-hidden rounded-[14px] border border-[#f0e0e6]">
            ...
            {adisyon.items.length === 0 && (
              <div className="bg-[#F7F6F6] px-3 py-6 text-center text-[11.5px] text-[#74616A]">Kalem yok.</div>
            )}
          </div>
          ...
          {adisyon.plannedInstallmentCount > 0 && (
            <div className="mt-2 flex items-center gap-1.5 rounded-[12px] border border-[#EAD8DF] bg-[#F7F6F6] px-3 py-2 text-[11px] text-[#8C4460]">
