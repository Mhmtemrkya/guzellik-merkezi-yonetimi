  ...
  return (
    <div className="relative w-full min-w-0 sm:w-auto sm:shrink-0">
      ...
      >
        ...
        />
        <div className="relative z-10 flex h-7 w-7 shrink-0 items-center justify-center rounded-[10px] border border-[#efbfd0] bg-[#fff1f6] text-[#c85776]">
          ...
          >
            ...
            <div className="relative border-b border-[#ead8df]/75 px-4 py-3">
              ...
              {selectedInstitution?.name && (
                <div className="mt-0.5 truncate text-[12px] font-semibold text-[#352432]">{selectedInstitution.name}</div>
              )}
